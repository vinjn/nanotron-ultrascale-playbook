...
Translations: [Simplified Chinese](https://lolitasian.blog.csdn.net/article/details/125529598), [French](https://lbourdois.github.io/blog/nlp/GPT2/), [Korean](https://chloamme.github.io/2021/12/08/illustrated-gpt2-korean.html), [Russian](https://habr.com/ru/post/490842/), [Turkish](https://devrimdanyal.medium.com/gpt-2-transformat%C3%B6r-dil-modellerinin-g%C3%B6rselle%C5%9Ftirilmesi-fc4bfd510223)

![](images/openAI-GPT-2-3_598ff55993a4.png)  
...
![](images/swiftkey-keyboard_f51a33aabcac.png)  
...
![](images/gpt2-sizes_83828aede0fe.png)  
...
![](images/transformer-encoder-decoder_eb26129324d7.png)  
...
![](images/gpt-2-transformer-xl-bert-3_6e59e841bf82.png)  
...
![](images/gpt2-sizes-hyperparameters-3_a1a4a58ed095.png)  
...
![](images/gpt-2-output_867096cb1727.gif)  
...
![](images/gpt-2-autoregression-2_90054e5dbad1.gif)  
...
![](images/transformer-encoder-block-2_f189afe01044.png)  
...
![](images/transformer-decoder-block-2_e089db3e88df.png)  
...
![](images/transformer-decoder-block-self-attention-2_29a90932c174.png)  
...
![](images/self-attention-and-masked-self-attention_003046c7d654.png)  
...
![](images/transformer-decoder-intro_a0dabd620a76.png)  
...
![](images/gpt-2-layers-2_edeaa56f982f.png)  
...
![](images/gpt2-simple-output-2_6e056a17a170.gif)
...
![](images/gpt-2-simple-output-3_9be6c37f2868.gif)  
...
![](images/gpt2-token-embeddings-wte-2_26d54f7159be.png)  
...
![](images/gpt2-positional-encoding_5643b13b3cd6.png)  
...
![](images/gpt2-input-embedding-positional-encoding-3_2826dc1f8b23.png)  
...
![](images/gpt2-transformer-block-vectors-2_08faab37431a.png)  
...
![](images/gpt2-self-attention-example-2_23bd2578a6f1.png)  
...
![](images/self-attention-example-folders-3_473b7ec4625f.png)  
...
![](images/self-attention-example-folders-scores-3_1c47b047c9d2.png)  

We multiply each value by its score and sum up – resulting in our self-attention outcome.

![](images/gpt2-value-vector-sum_3caf0810979d.png)  
...
![](images/gpt2-output-projection-2_a17e25aba70f.png)  
...
![](images/gpt2-output-scores-2_35a422014dd1.png)  

We can simply select the token with the highest score (top\_k = 1). But better results are achieved if the model considers other words as well. So a better strategy is to sample a word from the entire list using the score as the probability of selecting that word (so words with a higher score have a higher chance of being selected). A middle ground is setting top\_k to 40, and having the model consider the 40 words with the highest scores.

![](images/gpt2-output_14935036efe7.png)  
...
![](images/zoom-in_412c75e6646a.png)  
...
![](images/gpt2-self-attention-1-2_24356bfc9af5.png)  
...
![](images/self-attention-summary_39fed07087bd.png)  
...
![](images/self-attention-1_be2432fe9530.png)  
...
![](images/self-attention-2_cd76bf382f3c.png)  
...
![](images/self-attention-3-2_794539ff46db.png)  
...
![](images/masked-self-attention-2_83f36f0dbf07.png)  
...
![](images/transformer-decoder-attention-mask-dataset_ec4fb5ef2903.png)  
...
![](images/queries-keys-attention-mask_f4a2e0333b3d.png)  
...
![](images/transformer-attention-mask_c155d7e8ceaf.png)  

Then, applying softmax on each row produces the actual scores we use for self-attention:

![](images/transformer-attention-masked-scores-softmax_927b7d90bfd8.png)  
...
![](images/gpt2-self-attention-qkv-1-2_4b0ce5b6f1b6.png)  
...
![](images/gpt2-self-attention-qkv-2-2_96d87f8efbb3.png)  
...
![](images/gpt2-self-attention-qkv-3-2_32da01989d5f.png)  
...
![](images/gpt2-self-attention-1_afa177f49726.png)  
...
![](images/gpt2-self-attention-2_255cbfddc7d4.png)  
...
![](images/gpt2-self-attention-3_7e41eeb913e0.png)  
...
![](images/gpt2-self-attention-split-attention-heads-1_67099ea31998.png)  
...
![](images/gpt2-self-attention-split-attention-heads-2_397895acbaae.png)  
...
![](images/gpt2-self-attention-scoring_7e230cd2c9a2.png)  
...
![](images/gpt2-self-attention-scoring-2_b59671676154.png)  
...
![](images/gpt2-self-attention-multihead-sum-1_879eab9a7420.png)  
...
![](images/gpt2-self-attention-merge-heads-1_8952ab9a52bc.png)  
...
![](images/gpt2-self-attention-project-1_41a14b8e5eda.png)  

And with this, we have produced the vector we can send along to the next layer:

![](images/gpt2-self-attention-project-2_8e282b9fefc5.png)  
...
![](images/gpt2-mlp1_fabd84eee6d2.gif)  
...
![](images/gpt2-mlp-2_d8ac8ea5eabf.gif)  
(Not shown: A bias vector)
...
![](images/gpt2-transformer-block-weights-2_e666e5735d23.png)  
...
![](images/gpt2-weights-2_052d2b9742dd.png)  

If you want to see all the parameters of the model, then I have tallied them here:

![](images/gpt2-117-parameters_838fe725cea3.png)  
...
![](images/decoder-only-transformer-translation_8da340ff9c35.png)  
...
![](images/music-transformer-performance-encoding-3_f0fe4c762d3a.png)  
...
![](images/music-representation-example_16f67cdea353.png)  

The one-hot vector representation for this input sequence would look like this:

![](images/music-transformer-input-representation-2_06b0c84d3979.png)  
...
![](images/music-transformer-self-attention-2_1023207cc641.png)  
