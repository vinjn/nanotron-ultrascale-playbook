...
![LLM engine constructor](images/engine_constructor_f5b11a757164.png)
...
![Engine loop](images/engine_loop_f0c7c57b9ae9.png)
...
![KV cache blocks](images/kv_cache_blocks_92ff8d14dd10.png)
...
![fwd pass - continuous batching & paged attn](images/fwd_pass_3e6a70d892aa.png)
...
![Chunked prefilling - pt 1](images/chunked_pt1_e0b3ede8e6cd.png)
...
![Prefix caching logic - pt 1](images/prefix_pt1_498abd3803ff.png)
...
![Prefix caching logic - pt 2](images/prefix_pt2_c5c73ae4497f.png)
...
![Prefix caching logic - pt 3](images/prefix_pt3_2a7fe4e77913.png)
...
![FSM](images/fsm_44c19ee71e6f.png)
...
![FSM](images/fsm2_d812ac8e1ea2.png)
...
![Drafting stage](images/specdec_pt1_0ba74f4c32c6.png)

![Verify stage & rejection sampling stage](images/specdec_pt2_f94f19bc8466.png)
...
![disaggregated P/D](images/pd_c27c3e57de33.png)
...
![MultiProcExecutor](images/multiprocexecutor_63e1eb31ee98.png)
...
![server configuration with 2 8xH100 nodes](images/server_setup_b9dd52a15676.png)
...
![distributed system with 4 DPEngineCoreProc](images/dpenginecoreproc_65b08a2cb4ef.png)
...
Total tokens processed per second (input, output, or both), or alternatively requests per second

`Goodput`

Throughput that meets service-level objectives (SLOs) such as max TTFT, TPOT, or e2e latency. For example, only tokens from requests meeting those SLOs are counted

![ttft, itl, e2e latency](images/latency_diagram_fc530c2ad453.png)
...
![roofline perf model](images/roofline_f7e689f7bd05.png)
