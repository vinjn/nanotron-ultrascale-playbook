...
Overview[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#overview)
--------------------------------------------------------------------------------------------
...
What Is a KV Cache?[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#what-is-a-kv-cache)
-----------------------------------------------------------------------------------------------------------------
...
How LLMs Generate Text (Without and With a KV Cache)[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#how-llms-generate-text-without-and-with-a-kv-cache)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
![img](images/table1_f259485a0df0.png)
...
![img](images/table2_f040ba1cf4a9.png)
...
Implementing a KV Cache from Scratch[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#implementing-a-kv-cache-from-scratch)
----------------------------------------------------------------------------------------------------------------------------------------------------
...
1.  [`gpt_ch04.py`](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/03_kv-cache/gpt_ch04.py): Self-contained code taken from Chapters 3 and 4 of my _Build a Large Language Model (From Scratch)_ book to implement the LLM and run the simple text generation function
2.  [`gpt_with_kv_cache.py`](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/03_kv-cache/gpt_with_kv_cache.py): The same as above, but with the necessary changes made to implement the KV cache.
...
### 1\. Registering the Cache Buffers[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#1-registering-the-cache-buffers)
...
### 2\. Forward pass with `use_cache` flag[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#2-forward-pass-with-use_cache-flag)
...
### 3\. Clearing the Cache[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#3-clearing-the-cache)
...
### 4\. Propagating `use_cache` in the Full Model[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#4-propagating-use_cache-in-the-full-model)
...
### 5\. Using the Cache in Generation[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#5-using-the-cache-in-generation)
...
A Simple Performance Comparison[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#a-simple-performance-comparison)
------------------------------------------------------------------------------------------------------------------------------------------
...
![img](images/table3_9a7f209c7ee5.png)
...
KV cache Advantages and Disadvantages[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#kv-cache-advantages-and-disadvantages)
------------------------------------------------------------------------------------------------------------------------------------------------------
...
Optimizing the KV Cache Implementation[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#optimizing-the-kv-cache-implementation)
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Common Pitfalls When Scaling the Cache[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#common-pitfalls-when-scaling-the-cache)
...
#### Tip 1: Pre-allocate Memory[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#tip-1-pre-allocate-memory)
...
#### Tip 2: Truncate Cache via Sliding Window[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#tip-2-truncate-cache-via-sliding-window)
...
#### Optimizations in Practice[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#optimizations-in-practice)
...
Conclusion[](https://sebastianraschka.com/blog/2025/coding-the-kv-cache-in-llms.html#conclusion)
------------------------------------------------------------------------------------------------
