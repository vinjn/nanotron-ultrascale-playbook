...
中文翻译: [MatrixYao](https://huggingface.co/MatrixYao)

发表于 2023年2月3日
本文也提供英文版本 [English](https://huggingface.co/blog/vision_language_pretraining)。
...
![drawing](images/example1_7de8dd9d53e8.png)  
_小动物图片 [出处](https://www.istockphoto.com/photos/dog-cat-love)_
...
![Contrastive Learning](images/contrastive_learning_cc994c3d316f.png)  
_对比预训练和零样本图像分类有关内容参见 [这里](https://openai.com/blog/clip)_
...
![PrefixLM](images/prefixlm_a00fbf3d9aa7.png)  
_展示 PrefixLM 预训练策略的图片 (出处)_
...
![Frozen PrefixLM](images/frozen_prefixlm_00b2a1f918e1.png)  
_冻结 PrefixLM 预训练策略 ([图片出处](https://lilianweng.github.io/posts/2022-06-09-vlm))_
...
![Cross Attention Fusing](images/cross_attention_fusing_5dbbb1f1d8fb.png)  
_使用交叉注意力机制将视觉信息直接融合到语言模型中 ([图片出处](https://www.semanticscholar.org/paper/VisualGPT%3A-Data-efficient-Adaptation-of-Pretrained-Chen-Guo/616e0ed02ca024a8c1d4b86167f7486ea92a13d9))_
...
![MLM / ITM](images/mlm_itm_d584881e9ac2.png)  
_将图像与文本按部分相应对齐 ([图片出处](https://arxiv.org/abs/1908.02265))_
...
![ASIF](images/asif_3657e4e968c4.png)  
_用预训练的冻结的单模态图像和文本编码器创建一个相似性搜索空间 ([图片出处](https://luca.moschella.dev/publication/norelli-asif-2022))_
...
[](https://huggingface.co/blog/zh/vision_language_pretraining#%E6%95%B0%E6%8D%AE%E9%9B%86)数据集
...
![CLIPSeg 结果](images/clipseg_result_e7a88d597be7.png)
...
我们将继续集成最具影响力的计算机视觉和多模态模型，并希望收到你的回音。要了解多模态研究的最新消息，欢迎在 Twitter 上关注我们: [@adirik](https://twitter.com/https://twitter.com/alaradirik), [@NielsRogge](https://twitter.com/NielsRogge), [@apsdehal](https://twitter.com/apsdehal), [@a\_e\_roberts](https://twitter.com/a_e_roberts), [@RisingSayak](https://mobile.twitter.com/a_e_roberts), 和 [@huggingface](https://twitter.com/huggingface).

_致谢: 我们感谢 Amanpreet Singh 和 Amy Roberts 的严格审查。此外，还要感谢 Niels Rogge、Younes Belkada 和 Suraj Patil，以及 Hugging Face 的许多其他人，他们为促进基于 Transformers 的多模态模型的使用奠定了基础。_
