...
![](images/the_transformer_3_5d6f98a2641f.png)

Popping open that Optimus Prime goodness, we see an encoding component, a decoding component, and connections between them.

![](images/The_transformer_encoders_decoders_289e7b7c1f41.png)

The encoding component is a stack of encoders (the paper stacks six of them on top of each other – there’s nothing magical about the number six, one can definitely experiment with other arrangements). The decoding component is a stack of decoders of the same number.

![](images/The_transformer_encoder_decoder_stack_6ec3fbdc341f.png)

The encoders are all identical in structure (yet they do not share weights). Each one is broken down into two sub-layers:

![](images/Transformer_encoder_10d38d0f97a7.png)
...
![](images/Transformer_decoder_10b5ef3537dc.png)
...
![](images/embeddings_93cf3fed3d18.png)  
...
![](images/encoder_with_tensors_9eb08cc50087.png)  
...
![](images/encoder_with_tensors_2_43d10a52b39f.png)  
...
![](images/transformer_self-attention_visualization_90f5c8c65f8f.png)  
...
![](images/transformer_self_attention_vectors_d2b8f1c5f420.png)  
...
![](images/transformer_self_attention_score_26f6ecbd4a96.png)  
...
![](images/self-attention_softmax_3ab88e413ef5.png)  
...
![](images/self-attention-output_ebf9f6f22812.png)  
...
![](images/self-attention-matrix-calculation_7eaafcfacdc5.png)  
...
![](images/self-attention-matrix-calculation-2_6c82cacf68a6.png)  
...
![](images/transformer_attention_heads_qkv_415f88df679e.png)  
With multi-headed attention, we maintain separate Q/K/V weight matrices for each head resulting in different Q/K/V matrices. As we did before, we multiply X by the WQ/WK/WV matrices to produce Q/K/V matrices.

  
If we do the same self-attention calculation we outlined above, just eight different times with different weight matrices, we end up with eight different Z matrices

![](images/transformer_attention_heads_z_21dee5197e1c.png)  
...
![](images/transformer_attention_heads_weight_matrix_o_35bb5d3ed4df.png)  

That’s pretty much all there is to multi-headed self-attention. It’s quite a handful of matrices, I realize. Let me try to put them all in one visual so we can look at them in one place

  

![](images/transformer_multi-headed_self-attention-recap_704682c506f4.png)  

  

Now that we have touched upon attention heads, let’s revisit our example from before to see where the different attention heads are focusing as we encode the word “it” in our example sentence:

![](images/transformer_self-attention_visualization_2_073e379b0515.png)  
...
![](images/transformer_self-attention_visualization_3_1ddbb633ef5f.png)  
...
![](images/transformer_positional_encoding_vectors_2e4d4b18f69e.png)  
...
![](images/transformer_positional_encoding_example_31a082776921.png)  
...
![](images/transformer_positional_encoding_large_example_ceb1670fd08e.png)  
...
![](images/attention-is-all-you-need-positional-encoding_a4af3a84f119.png)  
...
![](images/transformer_resideual_layer_norm_30ec087ee260.png)  

If we’re to visualize the vectors and the layer-norm operation associated with self attention, it would look like this:

![](images/transformer_resideual_layer_norm_2_222aada7a183.png)  

This goes for the sub-layers of the decoder as well. If we’re to think of a Transformer of 2 stacked encoders and decoders, it would look something like this:

![](images/transformer_resideual_layer_norm_3_570b557f86a6.png)  
...
![](images/transformer_decoder_output_softmax_802c46a0b32d.png)  
...
![](images/vocabulary_817da6266a39.png)  
The output vocabulary of our model is created in the preprocessing phase before we even begin training.

Once we define our output vocabulary, we can use a vector of the same width to indicate each word in our vocabulary. This also known as one-hot encoding. So for example, we can indicate the word “am” using the following vector:

![](images/one-hot-vocabulary-example_f397ee1a6e3d.png)  
...
![](images/transformer_logits_output_and_label_f835e16f312d.png)  
...
![](images/output_target_probability_distributions_dda1cc09e38a.png)  
...
![](images/output_trained_model_probability_distributions_624506ed345a.png)  
